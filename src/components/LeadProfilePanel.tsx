...
const ETAPAS = [
    ...
    "Reserva", "Cierre Ganado", "En Pausa", "Descartados / En Pausa"
];
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select className="form-input text-sm" value={etapaActual} onChange={(e) => handleCambiarEtapa(e.target.value)} disabled={actualizandoEtapa}>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 text-sm text-[#1A1A1A]">
                                        <Building2 className="w-4 h-4 text-gray-400" />{lead.tipo_propiedad || "—"}
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-xl shadow p-6 flex flex-col">
                                            ...
                                            <div className="p-4 space-y-4">
                                                {bloque.preguntas.map((pregunta, pIdx) => (
                                                    <div key={pIdx}>
                                                        ...
                                                        <textarea rows={2} className="form-input resize-none text-xs" placeholder="Respuesta..."
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-100 flex-shrink-0">
                                <button onClick={handleGuardarRespuestas} disabled={guardando}
                        ...
                        <div className="bg-white rounded-xl shadow p-6 flex flex-col gap-5">
                            ...
                            <div>
                                ...
                                <textarea rows={3} className="form-input resize-none text-xs" placeholder="Escribe aquí el resultado de la llamada o una nota..." value={nuevaNota} onChange={(e) => setNuevaNota(e.target.value)} />
                                <button onClick={handleGuardarNota} className="mt-2 w-full py-2 bg-[#1E2D40] hover:bg-[#1E2D40]/90 text-white font-bold text-xs rounded-xl transition-all flex items-center justify-center gap-2">
