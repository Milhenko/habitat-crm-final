...
import {
    ...
    Calendar, User, ChevronDown, Building2
} from "lucide-react";
...
const MOCK_LEADS = [
    {
        ...
        telefono: "0991234567",
        estado: "Lead Entrante",
        tipo_propiedad: "Departamento",
        asesor: "J. Pérez",
        canal: "Meta Ads",
        fecha_creacion: "2026-03-20",
        fecha_asignacion: "2026-03-20",
    ...
    },
    {
        ...
        fecha_asignacion: "2026-03-19",
        fecha_reasignacion: "2026-03-21",
    },
    {
        id: "3",
        nombre: "Carlos López",
...
export default function ClientesPage() {
    ...
    const leads = MOCK_LEADS.filter(lead => {
        ...
        const matchAsesor = filtroAsesor ? lead.asesor === filtroAsesor : true;
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                            {leads.length} contactos encontrados
                        </p>
                    </div>
                    {canAddLead && (
                                ...
                                {leads.map((lead) => (
                                    <tr key={lead.id} className="hover:bg-gray-50 transition-colors group">
                                        ...
                                        <td className="px-4 py-4">
                                            ...
                                            href={`/leads/${lead.id}`}
                                            className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-[10px] font-bold rounded-lg transition-all whitespace-nowrap"
                      >
                                            Ver Perfil
                                        </a>
                                    </td>
